...
let nm = "Numerical Method (S.Samanta)";
let mp = "MicroProcesser (Pinaki Sir)";
let a = "Algorithm (S.Jana)";
let ac = "Analog Communication (T.Sinha)";
let ae = "Analog Electronics (D.C Sir)";
let ee = "Enginnering Electromagnetics (S.R Mukharjee)";
let lab1 = "Lab 1st Half";
let lab2 = "Lab 2nd Half";
let lab = "Lab";
let men = "Mentoring Class";
let b = "Lunch Break";
let free = "Free Period"

let routine = {
    1: [{ timeStart: 1000, timeEnd: 1050, sub: nm },
    { timeStart: 1050, timeEnd: 1140, sub: mp },
    { timeStart: 1140, timeEnd: 1230, sub: a},
    { timeStart: 1230, timeEnd: 1410, sub: b },
    { timeStart: 1410, timeEnd: 1500, sub: lab1 },
    { timeStart: 1500, timeEnd: 1550, sub: lab2 },
    { timeStart: 1550, timeEnd: 1640, sub: free }
   */ { timeStart: 1640, timeEnd: 1730, sub: free }*/],


    2: [{ timeStart: 1000, timeEnd: 1050, sub: ac },
    { timeStart: 1050, timeEnd: 1140, sub: ae },
    { timeStart: 1140, timeEnd: 1230, sub: ee },
    { timeStart: 1230, timeEnd: 1410, sub: b },
    { timeStart: 1410, timeEnd: 1500, sub: lab1 },
    { timeStart: 1500, timeEnd: 1550, sub: lab2 },
    { timeStart: 1550, timeEnd: 1640, sub: free }
    */{ timeStart: 1640, timeEnd: 1730, sub: lab2 }*/],
    ...
    3: [{ timeStart: 1000, timeEnd: 1050, sub: nm },
    { timeStart: 1050, timeEnd: 1140, sub: mp },
    { timeStart: 1140, timeEnd: 1230, sub: ac },
    { timeStart: 1230, timeEnd: 1410, sub: b },
    { timeStart: 1410, timeEnd: 1500, sub: lab1 },
    { timeStart: 1500, timeEnd: 1550, sub: lab2 },
    { timeStart: 1550, timeEnd: 1640, sub: free }
    */{ timeStart: 1640, timeEnd: 1730, sub: lab2 }*/],
    ...
    4: [{ timeStart: 1000, timeEnd: 1050, sub: ae },
    { timeStart: 1050, timeEnd: 1140, sub: a },
    { timeStart: 1140, timeEnd: 1230, sub:ee  },
    { timeStart: 1230, timeEnd: 1410, sub: b },
    { timeStart: 1410, timeEnd: 1500, sub: ac },
    { timeStart: 1500, timeEnd: 1550, sub: lab1 },
    { timeStart: 1550, timeEnd: 1640, sub: lab2 }],

    5: [{ timeStart: 1000, timeEnd: 1050, sub: a },
    { timeStart: 1050, timeEnd: 1140, sub: lab1 },
    { timeStart: 1140, timeEnd: 1230, sub: lab2 },
    { timeStart: 1230, timeEnd: 1410, sub: b },
    { timeStart: 1410, timeEnd: 1500, sub: mp },
    { timeStart: 1500, timeEnd: 1550, sub: ae },
    { timeStart: 1550, timeEnd: 1640, sub: men },
    */{ timeStart: 1640, timeEnd: 1730, sub: free },*/
    ]
};
